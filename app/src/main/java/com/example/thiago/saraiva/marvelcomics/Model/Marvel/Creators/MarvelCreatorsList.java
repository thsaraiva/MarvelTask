 ...
 */
public class MarvelCreatorsList {
...
//    collectionURI (string, optional): The path to the full list of creators in this collection.,
    MarvelCreatorSummary[]items; //The list of returned creators in this collection.
    ...
    MarvelCreatorSummary[] getItems() {
        return items;
    }

    public void setItems(MarvelCreatorSummary[] items) {
        this.items = items;
    }
}
